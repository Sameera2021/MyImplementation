...
public class MyDatabase extends SQLiteOpenHelper {
    public static final String DB_NAME ="EncryptedFiles.db";
    public static final int DB_VERSION = 1;

    public static final String INFO_TB_NAME ="Data";
    ...
    public boolean isert_key(Data data){
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(INFO_CL_OTPKEY,data.getOTPkey());
        values.put(INFO_CL_FILEPATH,data.getFilePath());
